      ...
      <Container style={styles.main}>
        <Content style={styles.content}>
          <Form onSubmit={this.handleSubmit}>
            <Item>
              <Input onChange={e => this.setState({ isim: e.nativeEvent.text })} style={styles.formInput} placeholder="İsim" />
            </Item>
            <Item>
              <Input onChange={e => this.setState({ soyisim: e.nativeEvent.text })} style={styles.formInput} placeholder="Soy İsim" />
            </Item>
            <Item>
              <Input onChange={e => this.setState({ tckimlik: e.nativeEvent.text })} style={styles.formInput} placeholder="TC Kimlik Numarası" />
            </Item>
            <Item>
